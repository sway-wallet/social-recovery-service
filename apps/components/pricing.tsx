...
export default function Pricing() {
  ...
  const plans = [
    {
      ...
      features: ["Default Guardian", "Secure Data Encryption", "Social Recovery"],
    ...
    },
    {
      ...
      features: ["All Basic Plan features", "Two Authorized Guardians", "Automatic Recovery"],
      actionLabel: "Get Started",
      popular: true,
    },
    {
      ...
      features: ["Notary Service", "All Basic Plan features", "All Pro Plan features", "24/7 support"],
      actionLabel: "Get Started",
      exclusive: true,
    },
    {
      ...
      price: "Custom",
      description: "Dedicated support and infrastructure to fit your needs",
      features: ["White label", "24/7 support", "Example Feature Number 3", "Super Exclusive Feature"],
  ...
  return (
    <div className="py-8">
      ...
      <div className="flex center"><Button>Add insurance for $15/month</Button></div>
    </div>
  )
}